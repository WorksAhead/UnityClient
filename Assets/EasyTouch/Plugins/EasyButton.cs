...
/// </summary>
[ExecuteInEditMode]
public class EasyButton : UnityEngine.MonoBehaviour
{
    ...
    [SerializeField]
    private UnityEngine.Vector2 offset = UnityEngine.Vector2.zero;
    /// <summary>
    ...
    [SerializeField]
    private UnityEngine.Vector2 scale = UnityEngine.Vector2.one;
    /// <summary>
    ...
    /// </summary>
    public UnityEngine.Color buttonNormalColor = UnityEngine.Color.white;
    ...
    /// </summary>
    public UnityEngine.Color buttonActiveColor = UnityEngine.Color.white;
    #endregion
        ...
        if (enable)
        {
            ...
            if (normalTexture != null && activeTexture != null)
            {
                ...
                if (normalTexture != null)
                {
                    ...
                    if (showDebugArea && UnityEngine.Application.isEditor)
                    {
                        GUI.Box(buttonRect, "");
                    }
                    ...
                    if (currentTexture != null)
                    {
                        ...
                        {
                            GUI.color = new UnityEngine.Color(currentColor.r, currentColor.g, currentColor.b, 0.2f);
                            if (UnityEngine.Application.isPlaying)
                            {
                                EasyTouch.RemoveReservedArea(buttonRect);
                            }
    ...
    void ComputeButtonAnchor(ButtonAnchor anchor)
    {
        ...
        if (normalTexture != null)
        {
            UnityEngine.Vector2 buttonSize = new UnityEngine.Vector2(normalTexture.width * scale.x, normalTexture.height * scale.y);
            UnityEngine.Vector2 anchorPosition = UnityEngine.Vector2.zero;

            // Anchor position
            switch (anchor)
            {
                case ButtonAnchor.UpperLeft:
                    anchorPosition = new UnityEngine.Vector2(0, 0);
                    break;
                case ButtonAnchor.UpperCenter:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width / 2 - buttonSize.x / 2, offset.y);
                    break;
                case ButtonAnchor.UpperRight:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width - buttonSize.x, 0);
                    break;

                case ButtonAnchor.MiddleLeft:
                    anchorPosition = new UnityEngine.Vector2(0, VirtualScreen.height / 2 - buttonSize.y / 2);
                    break;
                case ButtonAnchor.MiddleCenter:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width / 2 - buttonSize.x / 2, VirtualScreen.height / 2 - buttonSize.y / 2);
                    break;

                case ButtonAnchor.MiddleRight:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width - buttonSize.x, VirtualScreen.height / 2 - buttonSize.y / 2);
                    break;

                case ButtonAnchor.LowerLeft:
                    anchorPosition = new UnityEngine.Vector2(0, VirtualScreen.height - buttonSize.y);
                    break;
                case ButtonAnchor.LowerCenter:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width / 2 - buttonSize.x / 2, VirtualScreen.height - buttonSize.y);
                    break;
                case ButtonAnchor.LowerRight:
                    anchorPosition = new UnityEngine.Vector2(VirtualScreen.width - buttonSize.x, VirtualScreen.height - buttonSize.y);
                    break;
