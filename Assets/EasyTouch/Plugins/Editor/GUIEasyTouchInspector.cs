	...
	public override void OnInspectorGUI(){
		...
		if (t.showGeneral){
			...
			if (t.useBroadcastMessage){
				...
				t.receiverObject = (UnityEngine.GameObject)EditorGUILayout.ObjectField("Other receiver",t.receiverObject,typeof(UnityEngine.GameObject),true);
		...
		if (t.enable){
			...
			if (t.showSelect){
				t.easyTouchCamera = (UnityEngine.Camera)EditorGUILayout.ObjectField("Camera",t.easyTouchCamera,typeof(UnityEngine.Camera),true);
			...
			if (t.showSecondFinger){
				if (t.secondFingerTexture==null){
					t.secondFingerTexture =Resources.Load("secondFinger") as UnityEngine.Texture;
				}
				
				t.secondFingerTexture = (UnityEngine.Texture)EditorGUILayout.ObjectField("UnityEngine.Texture",t.secondFingerTexture,typeof(UnityEngine.Texture),true);
				...
				t.twistKey = (UnityEngine.KeyCode)EditorGUILayout.EnumPopup( "Twist & pinch key", t.twistKey);	
				t.swipeKey = (UnityEngine.KeyCode)EditorGUILayout.EnumPopup( "Swipe key", t.swipeKey);
			}
		}		
