...
public class CurvySplineAlignWizard : EditorWindow {
    ...
    UnityEngine.Vector3[] pos = new UnityEngine.Vector3[0];
    UnityEngine.Vector3[] up = new UnityEngine.Vector3[0];
    UnityEngine.Vector3[] tan = new UnityEngine.Vector3[0];
    ...
    static public void Create()
    {
        ...
        win.maxSize = new UnityEngine.Vector2(400, 205);
    ...
    void Preview(SceneView sceneView)
    {
        ...
        for (int i=0;i<pos.Length;i++){
            UnityEngine.Vector3 rv = (OrientationType == 0) ? up[i] : tan[i];
            Handles.ArrowCap(0, pos[i], (rv!=UnityEngine.Vector3.zero) ? UnityEngine.Quaternion.LookRotation(rv):UnityEngine.Quaternion.identity, 2);
        }
    }
}
