...
public class CBExample : UnityEngine.MonoBehaviour {
    public UnityEngine.GameObject[] CloneGroup1;
    public UnityEngine.GameObject[] CloneGroup2;
    public UnityEngine.GameObject[] CloneGroup3;
    public string[] CloneGroupNames;

    SplinePathCloneBuilder mBuilder;
    CurvySpline mSpline;
    UnityEngine.Transform mCPToMove;
    ...
    void Update()
    {
        ...
        if (mCPToMove)
            mCPToMove.Translate(UnityEngine.Vector3.up * UnityEngine.Mathf.Sin(UnityEngine.Mathf.PingPong(Time.time, 2) - 1)*5*Time.deltaTime);
    }
