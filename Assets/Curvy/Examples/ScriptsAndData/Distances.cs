...
public class Distances : UnityEngine.MonoBehaviour {
    public CurvySpline Spline;
    public UnityEngine.Transform Cube;
    public int Amount = 10;
    public float Speed = 1;

    UnityEngine.Transform[] cubes;
    float[] tf;
    int[] dir;
	...
	IEnumerator Start () {
        if (Spline && Cube) {
            ...
            cubes = new UnityEngine.Transform[Amount];
            tf = new float[Amount];
            dir = new int[Amount];
            cubes[0] = Cube;
            tf[0] = 0;
            ...
            Cube.localScale = new UnityEngine.Vector3(sc*0.7f, sc*0.7f, sc*0.7f);
            ...
            Speed = UnityEngine.Mathf.Abs(Speed);
        }
	}
    ...
    UnityEngine.Transform getCube()
    {
        return (UnityEngine.Transform)UnityEngine.GameObject.Instantiate(Cube);
    }
}
