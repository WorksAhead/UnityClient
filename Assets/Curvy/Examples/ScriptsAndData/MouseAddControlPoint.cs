...
public class MouseAddControlPoint : UnityEngine.MonoBehaviour {
	...
	IEnumerator Start () {
        ...
        Walker = UnityEngine.GameObject.FindObjectOfType(typeof(SplineWalkerDistance)) as SplineWalkerDistance;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0)) {
            UnityEngine.Vector3 p = Input.mousePosition;
            p.z = 10;
            p = UnityEngine.Camera.main.ScreenToWorldPoint(p);
            mSpline.Add(p);
