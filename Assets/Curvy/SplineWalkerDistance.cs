...
/// <summary>
/// Move a UnityEngine.Transform along a spline purely based on distance
/// </summary>
[ExecuteInEditMode]
public class SplineWalkerDistance : UnityEngine.MonoBehaviour
{
    ...
    void InitPosAndRot()
    {
        if (!Spline) return;
            ...
            // move UnityEngine.Transform onto the spline
