skill(150101)
{
  ...
  startcurvemove(100, true, 0.1, 0, 0, 0, 0, 0, 200, 0.1, 0, 0, 20, 0, 0, -150, 0.15, 0, 0, 5, 0, 0, 100, 0.15, 0, 0, 20, 0, 0, -100, 0.15, 0, 0, 5, 0, 0, 100, 0.15, 0, 0, 20, 0, 0, -100);
	...
	shakecamera2(289, true, 120, 40, 100, 0.06);
	...
	shakecamera2(589, true, 120, 40, 100, 0.06);
	...
	shakecamera2(889, true, 120, 40, 100, 0.06);
...
skill(150102)
{
  section(1450)
  {
	...
	shakecamera2(222, true, 120, 40, 100, 0.06);
	...
	shakecamera2(622, true, 120, 40, 100, 0.06);
	...
	shakecamera2(822, true, 120, 40, 100, 0.06);
	...
	shakecamera2(1122, true, 120, 40, 100, 0.06);
  };
...
skill(150103)
{
  ...
  startcurvemove(0, true, 0.1, 0, 0, 0, 0, 0, 100, 0.1, 0, 0, 10, 0, 0, -85, 0.15, 0, 0, 2, 0, 0, 100, 0.15, 0, 0, 16.5, 0, 0, -110);
	...
	shakecamera2(555, true, 120, 40, 100, 0.08);
