...
skill(300102)
{
  section(1400)
  {
    ...
    playsound(630, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BladeWoosh_2", false);
...
skill(300117)
{
  section(333)
  {
    addimpacttoself(0, 12990004, 333);
    addimpacttoself(0, 30011701, 333);
    addimpacttoself(0, 30011702, 333);
    movecontrol(true);
    animation("SwordS_02");
    findmovetarget(0, vector3(0, 0, 0), 10, 360, 0.5, 0.5, 0, -2);
    startcurvemove(10, true, 0.1, 0, -80, 40, 0, 0, 0, 0.22, 0, -80, 2, 0, 0, -8);
    charactereffect("Monster_FX/Campaign_Wild/01_Bluelf/6_Mon_Bluelf_SwordS_01", 333, "Bone_Root", 0);
    playsound(10, "huiwu", "Sound/Npc/Mon_Loop", 1500, "Sound/Npc/guaiwu_huiwuzhong_01", false);
    areadamage(100, 0, 1, 0, 4.2, true) {
      stateimpact("kDefault", 30011703);
    };
    shakecamera2(150, 100, true, true, vector3(0,0,0.2), vector3(0,0,150),vector3(0,0,0.5),vector3(0,0,30));
  };
  oninterrupt() //技能在被打断时会运行该段逻辑
  {
    stopeffect(0);
