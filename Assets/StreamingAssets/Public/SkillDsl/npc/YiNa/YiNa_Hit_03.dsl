...
skill(400003)
{
  ...
  section(200)//第一段
  {
    ...
    //
    //音效
    playsound(10, "Hit", "Sound/Cike/CikeSkillSound01", 1000, "Sound/Npc/YiNa/boss_YiNa_PuGong_03", false);
...
skill(400013)
{
  ...
  section(200)//第一段
  {
    ...
    areadamage(0, 0, 1.5, 1.1, 2.2, true)
		{
			stateimpact("kDefault", 40000115);
			stateimpact("kLauncher", 40000116);
			stateimpact("kKnockDown", 40000001);
      //showtip(200, 0, 1, 0);
		};
    areadamage(150, 0, 1.5, 1.1, 2.2, true)
		{
			stateimpact("kDefault", 40000117);
			stateimpact("kLauncher", 40000118);
			stateimpact("kKnockDown", 40000001);
      //showtip(200, 0, 1, 0);
		};
    //
