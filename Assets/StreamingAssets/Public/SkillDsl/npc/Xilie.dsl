...
skill(380205)
{
  ...
  section(933)
  {
    ...
    setanimspeed(10, "Skill_02A", 0.6, true);
...
skill(380212)
{
  ...
  section(933)
  {
    animation("Skill_02A");
    charactereffect("Monster_FX/Boss/6_Mon_Xilie_Xuli_01", 3800, "ef_weapon01", 0, true);
    shakecamera2(100, 1800, false, false, vector3(0.08,0.08,0.08), vector3(25,25,25),vector3(1.5,1.5,1.5),vector3(100,100,100));
    setanimspeed(30, "Skill_02A", 0.6, true);
    setanimspeed(930, "Skill_02A", 1, true);
  };
  //二段开炮
  section(500)
  {
    movecontrol(true);
    animation("Skill_02B");
    summonnpc(10, 101, "Monster_FX/Boss/6_Mon_Xilie_YuJing_01", 380213, vector3(0, 0, 0));
    playsound(140, "kaipao", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_01", false);
    charactereffect("Monster_FX/Boss/6_Mon_Xilie_PaoKou_01", 800, "ef_weapon01", 160, false);
    startcurvemove(170, true, 0.1, 0, 0, -3, 0, 0, 0);
  };
  ...
  {
    animation("Skill_02B");
    playsound(140, "kaipao1", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_01", false);
    charactereffect("Monster_FX/Boss/6_Mon_Xilie_PaoKou_01", 800, "ef_weapon01", 160, false);
  };
  ...
  {
    animation("Skill_02B");
    playsound(140, "kaipao2", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_01", false);
    charactereffect("Monster_FX/Boss/6_Mon_Xilie_PaoKou_01", 800, "ef_weapon01", 160, false);
  };
...
skill(380213)
{
  section(5000)
  {
    ...
    settransform(10," ",vector3(0,0,0),eular(0,0,0),"RelativeTarget",false,true);
    setenable(20, "Visible", true);
    areadamage(3000, 0, 1.5, 0, 4, true) {
      stateimpact("kDefault", 38021201);
      stateimpact("kLauncher", 38021202);
    };
    shakecamera2(3010,550,false,false,vector3(0.5,1.3,0.5),vector3(50,80,50),vector3(5,7,5),vector3(85,85,85));
    setenable(3005, "Visible", false);
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Paodan_01", 1500, vector3(0,0,0), 2800, eular(0,0,0));
    playsound(2950, "baozha", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_02", false);
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Baozha_01", 800, vector3(0,0,0), 3000);

    //
    areadamage(4000, 0, 1.5, 0, 4, true) {
      stateimpact("kDefault", 38021201);
      stateimpact("kLauncher", 38021202);
    };
    shakecamera2(4010,550,false,false,vector3(0.5,1.3,0.5),vector3(50,80,50),vector3(5,7,5),vector3(85,85,85));
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Paodan_01", 1500, vector3(0,0,0), 3800, eular(0,90,0));
    playsound(3950, "baozha1", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_02", false);
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Baozha_01", 800, vector3(0,0,0), 4000);

    //
    areadamage(3500, 0, 1.5, 0, 4, true) {
      stateimpact("kDefault", 38021201);
      stateimpact("kLauncher", 38021202);
    };
    shakecamera2(3510,550,false,false,vector3(0.5,1.3,0.5),vector3(50,80,50),vector3(5,7,5),vector3(85,85,85));
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Paodan_01", 1500, vector3(0,0,0), 3300, eular(0,270,0));
    playsound(3450, "baozha2", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_xilie_jupaodaji_02", false);
    sceneeffect("Monster_FX/Boss/6_Mon_Xilie_Baozha_01", 800, vector3(0,0,0), 3500);
    destroyself(5000);
  };
};