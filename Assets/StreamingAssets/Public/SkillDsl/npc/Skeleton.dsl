...
//    findmovetarget(1425, vector3(0,0,0),3,50,0.5,0.5,0,-2);
    ...
    playsound(1300, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BladeWoosh_1", false);
...
//    sound("Sound/Swordman/TiaoKong", 620);//无定帧时的音效开始时间
    ...
    playsound(1630, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BladeWoosh_2", false);
...
//    sound("Sound/Swordman/TiaoKong", 620);//无定帧时的音效开始时间
    ...
    playsound(1613, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BladeWoosh_2", false);
...
//    findmovetarget(1425, vector3(0,0,0),3,50,0.5,0.5,0,-2);
    ...
    startcurvemove(1530, true, 0.15, 0, 0, 3, 0, 0, 0);
    startcurvemove(1970, true, 0.2, 0, 0, 2, 0, 0, 0, 0.2, 0, 0, 0.5, 0, 0, 0);
    playsound(1330, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BladeWoosh_1", false);
    areadamage(1333, 0, 1, 0.5, 2.5, false) {
