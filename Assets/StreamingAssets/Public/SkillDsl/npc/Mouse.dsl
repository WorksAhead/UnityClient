...
skill(300501)
{
  section(2133)
  {
    ...
    playsound(1110, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
...
skill(300503)
{
  section(2700)
  {
    ...
    playsound(1000, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_liquid", false);
...
skill(300504)
{
  section(1133)
  {
    movecontrol(true);
    animation("Skill_01");
    playsound(310, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
    ...
    playsound(600, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
...
skill(300506)
{
  section(5900)
  {
    playsound(0, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_liquid", false);
