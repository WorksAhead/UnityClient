...
skill(300201)
{
  section(1882)
  {
    ...
    playsound(495, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
    ...
    playsound(1160, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
...
skill(300202)
{
  section(2083)
  {
    ...
    playsound(1665, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_claws", false);
...
skill(300205)
{
  section(1400)
  {
    ...
    findmovetarget(100, vector3(0,0,0),10,180,0.3,0.7,0,0);
    facetotarget(500, 3000, 50);
    setchildvisible(770,"5_Mon_Blof_02_w_01",false);
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390001, vector3(0, 0, 0));
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390012, vector3(0, 0, 0));
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390013, vector3(0, 0, 0));
    setanimspeed(850, "Skill_01", 4, true);
    setanimspeed(1350, "Skill_01", 1, true);
  };
  section(1400)
  {
    animation("Skill_01");
    setchildvisible(50,"5_Mon_Blof_02_w_01",true);
    setanimspeed(50, "Skill_01", 3, true);
    setanimspeed(450, "Skill_01", 1, true);
    setchildvisible(770,"5_Mon_Blof_02_w_01",false);
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390001, vector3(0, 0, 0));
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390012, vector3(0, 0, 0));
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390013, vector3(0, 0, 0));
  ...
  section(1400)
  {
    ...
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390012, vector3(0, 0, 0));
    summonnpc(760, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390013, vector3(0, 0, 0));
    setchildvisible(1350,"5_Mon_Blof_02_w_01",true);
  };
  oninterrupt() //技能在被打断时会运行该段逻辑
  {
    setchildvisible(0,"5_Mon_Blof_02_w_01",true);
  };
  onstop() //技能正常结束时会运行该段逻辑
  {
    setchildvisible(0,"5_Mon_Blof_02_w_01",true);
