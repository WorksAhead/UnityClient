...
skill(300111)
{
  section(4833)
  {
    ...
    playsound(1005, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_smash", false);
    areadamage(1030, 0, 1, 1.5, 3.5, true) {
    ...
    playsound(2475, "huiwu3", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_smash", false);
    areadamage(2500, 0, 1, 1.5, 3.5, true) {
    ...
    setanimspeed(3000, "Skill_01", 2.5, true);
    setanimspeed(4800, "Skill_01", 1, true);
  };
};
...
skill(300112)
{
  section(3433)
  {
    movecontrol(true);
    animation("Skill_03");
    setanimspeed(50, "Skill_03", 2, true);
    setanimspeed(750, "Skill_03", 1, true);
    ...
    playsound(945, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_smash", false);
    areadamage(970, 0, 1, 1.5, 3.5, false) {
    ...
    setanimspeed(1500, "Skill_03", 2.5, true);
    setanimspeed(3400, "Skill_03", 1, true);
  };
};
...
skill(300114)
{
  section(6333)
  {
    ...
    playsound(3210, "huiwu1", "Sound/Npc/Mon", 2000, "Sound/Npc/monster_smash", false);
...
//    sound("Sound/Swordman/TiaoKong", 620);//无定帧时的音效开始时间
    ...
    areadamage(1325, 0, 1, 1.5, 3.5, true) {
    ...
    areadamage(2660, 0, 1, 1.5, 3.5, true) {
...
skill(300116)
{
  section(600)
  {
    ...
    colliderdamage(40, 600, false, false, 0, 0)
    {
      ...
      sceneboxcollider(vector3(3.5, 3, 3.5), vector3(0, 0, 0), eular(0, 0, 0), true, false);
    };
    destroyself(600);
    playsound(30, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_DiZhenBo", false){
      position(vector3(0,0,0), false);
    };;
    playsound(200, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_DiZhenBo", false){
      position(vector3(0,0,0), false);
    };;
    playsound(370, "huiwu2", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_DiZhenBo", false){
      position(vector3(0,0,0), false);
    };;
    playsound(540, "huiwu3", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_DiZhenBo", false){
      position(vector3(0,0,0), false);
    };;
