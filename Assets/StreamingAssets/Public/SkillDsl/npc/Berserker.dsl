...
skill(380101)
{
  ...
  section(1433)
  {
    ...
    setanimspeed(30, "Attack_01A", 3, true);
    setanimspeed(1400, "Attack_01A", 1, true);
  };
  //二段挥砍
  section(1767)
  {
...
skill(380103)
{
  ...
  section(960)
  {
    ...
    findmovetarget(300, vector3(0,0,0),4,20,0.5,0.5,0,-2);
  ...
  section(1767)
  {
    movecontrol(true);
    animation("Attack_01B");
    findmovetarget(120, vector3(0,0,0),5,60,0.5,0.5,0,-2);
    startcurvemove(250, true, 0.1, 0, 0, 8, 0, 0, 0, 0.18, 0, 0, 20, 0, 0, -100);
    sceneeffect("Monster_FX/Campaign_Wild/02_Blof/6_Mon_Blof_ChenTu_01", 1000, vector3(0,0,0), 240);
    playsound(305, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_mohuakuangzhanshi_liankan_01", false);
    charactereffect("Monster_FX/Boss/5_Mon_Berserker_DaoGuang_01_01", 1000, "Bone_Root", 310);
    ...
    playsound(725, "huiwu1", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_mohuakuangzhanshi_liankan_02", false);
    charactereffect("Monster_FX/Boss/5_Mon_Berserker_DaoGuang_01_02", 1000, "Bone_Root", 730);
    startcurvemove(750, true, 0.1, 0, 0, 10, 0, 0, 0, 0.11, 0, 0, 20, 0, 0, -150);
...
skill(380106)
{
  ...
  section(1000)
  {
    ...
    playsound(180, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/monster_BaoQi", false);
...
skill(380107)
{
  section(1500)
  {
    ...
    playsound(880, "huiwu", "Sound/Npc/Mon", 1500, "Sound/Npc/monster_DiZhenBo", false);
...
skill(380111)
{
  ...
  {
    animation("Skill_01A");
    setanimspeed(50, "Skill_01A", 2, true);
    setanimspeed(1900, "Skill_01A", 1, true);
    findmovetarget(5,vector3(0,0,0),20,360,0.5,0.5,0,0);
    facetotarget(10, 1200, 50);
    sceneeffect("Monster_FX/Campaign_Wild/01_Bluelf/6_Monster_YuJing_Line_01", 1500, vector3(0, 0, 0), 10, eular(0, 0, 0), vector3(1, 1, 1), true);//场景粒子在特殊位置仍然有不同步方向问题
  };
  //二段出子物体
  section(1567)
  {
    animation("Skill_01B");
    playsound(350, "huiwu", "Sound/Npc/Mon", 1000, "Sound/Npc/boss_mohuakuangzhanshi_zadijifei_01", false);
    summonnpc(380, 101, "Monster_FX/Campaign_Wild/6_Monster_YuJing_01", 380112, vector3(0, 0, 0));
    charactereffect("Monster_FX/Campaign_Wild/Public/6_Mon_Baodian_01", 800, "ef_lefthand", 380, false);
    shakecamera2(380, 200, false, true, vector3(0, 0.8, 0), vector3(0, 50, 0), vector3(0, 1, 0), vector3(0, 80, 0));
  };
};
...
skill(380112)
{
  section(2000)
  {
    ...
    setenable(0, "Visible", false);
    settransform(0," ",vector3(0,0,0),eular(0,0,0),"RelativeOwner",false);
    startcurvemove(10, true, 0.6, 0, 0, 25, 0, 0, 0);
    sceneeffect("Monster_FX/Boss/5_Mon_Berserker_ZhenDangBo_01", 1000, vector3(0,0,0),150);
    sceneeffect("Monster_FX/Boss/5_Mon_Berserker_ZhenDangBo_01", 1000, vector3(0,0,0),300);
    sceneeffect("Monster_FX/Boss/5_Mon_Berserker_ZhenDangBo_01", 1000, vector3(0,0,0),450);
    sceneeffect("Monster_FX/Boss/5_Mon_Berserker_ZhenDangBo_01", 1000, vector3(0,0,0),600);
    playsound(130, "huiwu", "Sound/Npc/Mon", 2000, "Sound/Npc/boss_mohuakuangzhanshi_zadijifei_02", false);
    playsound(280, "huiwu1", "Sound/Npc/Mon", 2000, "Sound/Npc/boss_mohuakuangzhanshi_zadijifei_02", false);
    playsound(430, "huiwu2", "Sound/Npc/Mon", 2000, "Sound/Npc/boss_mohuakuangzhanshi_zadijifei_02", false);
    playsound(580, "huiwu3", "Sound/Npc/Mon", 2000, "Sound/Npc/boss_mohuakuangzhanshi_zadijifei_02", false);
    colliderdamage(100, 500, true, true, 200, 1)
    {
      stateimpact("kDefault", 38010201);
      sceneboxcollider(vector3(3.5, 2, 3.5), vector3(0, 1, 0), eular(0, 0, 0), true, false);
    };
    //setenable(1050, "Visible", false);
    shakecamera2(130, 100, false, true, vector3(0, 0.8, 0), vector3(0, 50, 0), vector3(0, 1, 0), vector3(0, 80, 0));
    shakecamera2(280, 100, false, true, vector3(0, 0.8, 0), vector3(0, 50, 0), vector3(0, 1, 0), vector3(0, 80, 0));
    shakecamera2(430, 100, false, true, vector3(0, 0.8, 0), vector3(0, 50, 0), vector3(0, 1, 0), vector3(0, 80, 0));
    shakecamera2(580, 100, false, true, vector3(0, 0.8, 0), vector3(0, 50, 0), vector3(0, 1, 0), vector3(0, 80, 0));
    destroyself(1800);
  };
};