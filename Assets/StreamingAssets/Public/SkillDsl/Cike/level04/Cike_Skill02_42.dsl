...
skill(120242)
{
  section(1)//初始化 0
  {
    ...
    movecontrol(true);
    setlayer(0, 2600, "NoBlockCharacter");
  };
...
////////////////////////////////////////////////////////////////////////////////
  ...
  section(333)//第一段 13
  {
    ...
    sceneeffect("Hero_FX/3_Cike/3_Hero_CiKe_BiaoLianHua_03_001", 3000, vector3(0, 0.1, 0), 80, eular(0, 0, 0), vector3(1, 1, 1), true);
    //
    //音效
    playsound(10, "Hit06", "Sound/Cike/CikeSkillSound01", 3000, "Sound/Cike/Cike_Voice_ShangTiao_04", false);
    //
    //检测地面高度
    checkonground(1, 0.2, "ToGround");
  };
