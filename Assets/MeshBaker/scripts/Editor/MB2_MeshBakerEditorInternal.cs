...
public class MB2_MeshBakerEditorInternal{
	...
	private static GUIContent
		...
		renderTypeGUIContent = new GUIContent("UnityEngine.Renderer","The type of renderer to add to the combined mesh."),
		...
		useTextureBakerObjsGUIContent = new GUIContent("Same As UnityEngine.Texture Baker","Build a combined mesh using using the same list of objects that generated the Combined Material"),
