...
public class EasyTouchGesture{
	...
	/// </summary>
	public UnityEngine.Vector2 swipeVector;			
	/// <summary>
	...
	/// </summary>
	public UnityEngine.GameObject otherReceiver; 
	/// <summary>
	...
	/// </summary>
	/// <returns>
	/// UnityEngine.Vector3 : world position
	/// </returns>
	/// <param name='z'>
	...
	/// true = r
	/// </param>
	public UnityEngine.Vector3 GetTouchToWordlPoint(float z, bool worldZ=false){
		
		if (!worldZ){
			return  EasyTouch.GetCamera().ScreenToWorldPoint( new UnityEngine.Vector3( position.x, position.y,z));	
		}
		else{
			return  EasyTouch.GetCamera().ScreenToWorldPoint( new UnityEngine.Vector3( position.x, position.y,z-EasyTouch.GetCamera().transform.position.z));	
		}
	}
	...
	public float GetSwipeOrDragAngle(){
		return UnityEngine.Mathf.Atan2( swipeVector.normalized.y,swipeVector.normalized.x) * UnityEngine.Mathf.Rad2Deg;	
	}
	/// <summary>
	...
	public UnityEngine.Vector2 NormalizedPosition(){
		return new UnityEngine.Vector2(100f/Screen.width*position.x/100f,100f/Screen.height*position.y/100f);	
	}
