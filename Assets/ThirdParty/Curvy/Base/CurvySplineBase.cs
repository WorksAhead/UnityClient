...
/// </summary>
public class CurvySplineBase : UnityEngine.MonoBehaviour
{
    ...
    public virtual UnityEngine.Vector3 Interpolate(float tf) { return UnityEngine.Vector3.zero; }
    /// <summary>
    /// Gets the interpolated position for a certain TF
    /// </summary>
    /// <remarks>TF (Total Fragment) relates to the total length of the spline</remarks>
    ...
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 InterpolateFast(float tf) { return UnityEngine.Vector3.zero; }
    /// <summary>
    ...
    public virtual UnityEngine.Vector3 InterpolateUserValue(float tf, int index) { return UnityEngine.Vector3.zero; }
    /// <summary>
    ...
    /// <param name="tf">TF value reflecting position on spline(0..1)</param>
    /// <returns>the interpolated value</returns>
    public virtual UnityEngine.Vector3 InterpolateScale(float tf) { return UnityEngine.Vector3.zero; }
    /// <summary>
    /// Gets the Up-Vector for a certain TF based on the splines' Orientation mode
    /// </summary>
    /// <param name="tf">TF value reflecting position on spline (0..1)</param>
    /// <returns>the Up-Vector</returns>
    public virtual UnityEngine.Vector3 GetOrientationUpFast(float tf) { return UnityEngine.Vector3.zero; }
    /// <summary>
    /// Gets a rotation looking to Tangent with the head upwards along the Up-Vector
    /// </summary>
    /// <param name="tf">TF value reflecting position on spline (0..1)</param>
    /// <returns>a rotation</returns>
    public virtual UnityEngine.Quaternion GetOrientationFast(float tf) { return UnityEngine.Quaternion.identity; }
    /// <summary>
    /// Gets the normalized tangent for a certain TF
    /// </summary>
    /// <param name="tf">TF value identifying position on spline (0..1)</param>
    /// <returns>a tangent vector</returns>
    public virtual UnityEngine.Vector3 GetTangent(float tf) { return UnityEngine.Vector3.zero; }
    /// <summary>
    ...
    /// <returns>a tangent vector</returns>
    public virtual UnityEngine.Vector3 GetTangent(float tf, UnityEngine.Vector3 position) { return UnityEngine.Vector3.zero; }
    /// <summary>
    /// Gets the normalized tangent for a certain TF using a linear approximation
    /// </summary>
    /// <param name="tf">TF value identifying position on spline (0..1)</param>
    /// <returns>a tangent vector</returns>
    public virtual UnityEngine.Vector3 GetTangentFast(float tf) { return UnityEngine.Vector3.zero; }
    ...
    public virtual float GetNearestPointTF(UnityEngine.Vector3 p) { return 0; }
    /// <summary>
    ...
    public virtual UnityEngine.Vector3[] GetApproximation() { return GetApproximation(false); }
    /// <summary>
    /// Gets an array containing all approximation points
    /// </summary>
    ...
    public virtual UnityEngine.Vector3[] GetApproximation(bool local) {return new UnityEngine.Vector3[0];}
    /// <summary>
    /// Gets an array containing all approximation tangents
    /// </summary>
    /// <remarks>This can be used to feed meshbuilders etc...</remarks>
    /// <returns>an array of tangents</returns>
    public virtual UnityEngine.Vector3[] GetApproximationT() { return new UnityEngine.Vector3[0];}
    /// <summary>
    /// Gets an array containing all approximation Up-Vectors
    /// </summary>
    /// <remarks>This can be used to feed meshbuilders etc...</remarks>
    /// <returns>an array of Up-Vectors</returns>
    public virtual UnityEngine.Vector3[] GetApproximationUpVectors(){ return new UnityEngine.Vector3[0];}

    #endregion

    protected float mLength;
    protected UnityEngine.Transform mTransform;
    ...
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 Move(ref float tf, ref int direction, float fDistance, CurvyClamping clamping)
    {
    ...
    /// <param name="clamping">clamping mode</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveFast(ref float tf, ref int direction, float fDistance, CurvyClamping clamping)
    {
        tf += fDistance * direction;
        ClampTF(ref tf, ref direction, clamping);
    ...
    /// <param name="clamping">clamping mode</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveBy(ref float tf, ref int direction, float distance, CurvyClamping clamping)
    {
    ...
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveBy(ref float tf, ref int direction, float distance, CurvyClamping clamping, float stepSize)
    {
    ...
    /// <param name="clamping">clamping mode</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveByFast(ref float tf, ref int direction, float distance, CurvyClamping clamping)
    {
    ...
    /// <param name="stepSize">stepSize defines the accuracy</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveByFast(ref float tf, ref int direction, float distance, CurvyClamping clamping, float stepSize)
    {
    ...
    /// <param name="clamping">clamping mode</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveByLengthFast(ref float tf, ref int direction, float distance, CurvyClamping clamping)
    {
    ...
    /// <param name="stepSize">stepSize defines the accuracy</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveByAngle(ref float tf, ref int direction, float angle, CurvyClamping clamping, float stepSize)
    {
        if (clamping == CurvyClamping.PingPong) {
            Debug.LogError("CurvySplineBase.MoveByAngle: PingPong clamping isn't supported!");
            return UnityEngine.Vector3.zero;
        }
        stepSize = UnityEngine.Mathf.Max(0.0001f, stepSize);
        float initialTF = tf;
        UnityEngine.Vector3 initialP = Interpolate(tf);
        UnityEngine.Vector3 initialT = GetTangent(tf, initialP);
        ...
        while (deadlock-- > 0) {
            ...
            P2 = Interpolate(tf);
            T2 = P2 - initialP;
            float accAngle = UnityEngine.Vector3.Angle(initialT, T2);
            if (accAngle >= angle) {
    ...
    /// <param name="stepSize">stepSize defines the accuracy</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 MoveByAngleFast(ref float tf, ref int direction, float angle, CurvyClamping clamping, float stepSize)
    {
        if (clamping == CurvyClamping.PingPong) {
            Debug.LogError("CurvySplineBase.MoveByAngle: PingPong clamping isn't supported!");
            return UnityEngine.Vector3.zero;
        ...
        stepSize = UnityEngine.Mathf.Max(0.0001f, stepSize);
        float initialTF = tf;
        UnityEngine.Vector3 initialP = InterpolateFast(tf);
        UnityEngine.Vector3 initialT = GetTangentFast(tf);
        UnityEngine.Vector3 P2 = UnityEngine.Vector3.zero;
        UnityEngine.Vector3 T2;
        int deadlock = 10000;
        while (deadlock-- > 0) {
    ...
    public virtual UnityEngine.Vector3 GetExtrusionPoint(float tf, float radius, float angle)
    {
        UnityEngine.Vector3 pos = Interpolate(tf);
        UnityEngine.Vector3 tan = GetTangent(tf, pos);
        UnityEngine.Quaternion R = UnityEngine.Quaternion.AngleAxis(angle, tan);
    ...
    /// <param name="angle">angle in degrees</param>
    /// <returns>the extruded point</returns>
    public virtual UnityEngine.Vector3 GetExtrusionPointFast(float tf, float radius, float angle)
    {
        UnityEngine.Vector3 pos = InterpolateFast(tf);
        UnityEngine.Vector3 tan = GetTangentFast(tf);
        UnityEngine.Quaternion R = UnityEngine.Quaternion.AngleAxis(angle, tan);
        return pos + (R * GetOrientationUpFast(tf)) * radius;
    }
    ...
    public virtual UnityEngine.Vector3 GetTangentByDistance(float distance)
    {
    ...
    /// <param name="distance">distance in the range of 0..Length</param>
    /// <returns>the tangent/direction</returns>
    public virtual UnityEngine.Vector3 GetTangentByDistanceFast(float distance)
    {
    ...
    /// <param name="distance">distance in the range of 0..Length</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 InterpolateByDistance(float distance)
    {
    ...
    /// <param name="distance">distance in the range of 0..Length</param>
    /// <returns>the interpolated position</returns>
    public virtual UnityEngine.Vector3 InterpolateByDistanceFast(float distance)
    {
    ...
    {
        stepSize = UnityEngine.Mathf.Max(0.0001f, stepSize);
        UnityEngine.Vector3 p = Interpolate(tf);
        float tf1;
        if (tf == 1)
            tf1 = UnityEngine.Mathf.Min(1f, tf - stepSize);
        else
            tf1 = UnityEngine.Mathf.Min(1f, tf + stepSize);

        stepSize = UnityEngine.Mathf.Abs(tf1 - tf);
        UnityEngine.Vector3 p1 = Interpolate(tf1);
    ...
    {
        stepSize = UnityEngine.Mathf.Max(0.0001f, stepSize);
        UnityEngine.Vector3 p = InterpolateFast(tf);
        float tf1;
        if (tf == 1)
            tf1 = UnityEngine.Mathf.Min(1f, tf - stepSize);
        else
        ...
        stepSize = UnityEngine.Mathf.Abs(tf1 - tf);
        UnityEngine.Vector3 p1 = InterpolateFast(tf1);
        float mag = (p1 - p).magnitude;
    ...
    {
        UnityEngine.Vector3[] p = GetApproximation(local);
        UnityEngine.Vector3 min = new UnityEngine.Vector3(float.MaxValue, float.MaxValue, float.MaxValue);
        UnityEngine.Vector3 max = new UnityEngine.Vector3(float.MinValue, float.MinValue, float.MinValue);
        for (int i = 0; i < p.Length; i++) {
            min.x = UnityEngine.Mathf.Min(min.x, p[i].x);
            min.y = UnityEngine.Mathf.Min(min.y, p[i].y);
            min.z = UnityEngine.Mathf.Min(min.z, p[i].z);
            max.x = UnityEngine.Mathf.Max(max.x, p[i].x);
            max.y = UnityEngine.Mathf.Max(max.y, p[i].y);
            max.z = UnityEngine.Mathf.Max(max.z, p[i].z);
        }
    ...
    protected virtual bool ClampTF(ref float tf, ref int dir, CurvyClamping clamping)
    {
        switch (clamping) {
            case CurvyClamping.Loop:
                if (tf < 0) {
                    tf = 1 - UnityEngine.Mathf.Abs(tf % 1);
                    return true;
                }
                else if (tf > 1) {
                    tf = tf % 1;
