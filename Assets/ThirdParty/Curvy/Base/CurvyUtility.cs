...
namespace Curvy.Utils
{
    ...
    public class MeshInfo
    {
        ...
        public UnityEngine.Vector3[] EdgeVertices = new UnityEngine.Vector3[0];
        public UnityEngine.Vector2[] EdgeUV = new UnityEngine.Vector2[0];
        // full Mesh
        ...
        public MeshInfo(Mesh mesh, bool calculateLoops, bool mirror)
        {
            ...
            UnityEngine.Vector3[] vt = mesh.vertices;
            UnityEngine.Vector2[] uv = mesh.uv;
            int[] tri = mesh.triangles;

            // Fill data arrays
            Vertices = new UnityEngine.Vector3[vt.Length];
            UVs = new UnityEngine.Vector2[uv.Length];
            ...
            if (calculateLoops) {
                ...
                // Fill Outline Data
                EdgeVertices = new UnityEngine.Vector3[vt.Length];
                EdgeUV = new UnityEngine.Vector2[uv.Length];
                ...
                foreach (EdgeLoop loop in EdgeLoops) {
                    for (int vi = 0; vi < loop.vertexCount; vi++) {
                        ...
                        minIndex = UnityEngine.Mathf.Min(minIndex, loop.vertexIndex[vi]);
                    }
                ...
                System.Array.Resize<UnityEngine.Vector3>(ref EdgeVertices, vertsUsed);
                System.Array.Resize<UnityEngine.Vector2>(ref EdgeUV, vertsUsed);
            }
        }

        public UnityEngine.Vector3[] TRSVertices(Matrix4x4 matrix)
        {
            UnityEngine.Vector3[] res = new UnityEngine.Vector3[Vertices.Length];
    ...
    public class MeshHelper
    {
        public static void CalculateMeshTangents(Mesh mesh)
        {
            ...
            for (long a = 0; a < triangleCount; a += 3) {
                ...
                UnityEngine.Vector3 v1 = vertices[i1];
                UnityEngine.Vector3 v2 = vertices[i2];
                UnityEngine.Vector3 v3 = vertices[i3];

                UnityEngine.Vector2 w1 = uv[i1];
                UnityEngine.Vector2 w2 = uv[i2];
                UnityEngine.Vector2 w3 = uv[i3];
            ...
            for (long a = 0; a < vertexCount; ++a) {
                ...
                UnityEngine.Vector3.OrthoNormalize(ref n, ref t);
                tangents[a].x = t.x;
                tangents[a].y = t.y;
                tangents[a].z = t.z;
        ...
        public static Mesh CreateLineMesh(float width)
        {
            ...
            Mesh mesh = new Mesh();
            mesh.vertices = new UnityEngine.Vector3[2] { new UnityEngine.Vector3(-width / 2, 0, 0), new UnityEngine.Vector3(width / 2, 0, 0) };
            mesh.uv = new UnityEngine.Vector2[2] { new UnityEngine.Vector2(0, 0), new UnityEngine.Vector2(1, 0) };
        ...
        public static Mesh CreateNgonMesh(int n, float radius, float hollowPercent)
        {
            ...
            int[] tris;
            float a = UnityEngine.Mathf.PI * 2 / (float)n;

            if (hollowPercent == 0) {
                verts = new UnityEngine.Vector3[n + 1];
                uv = new UnityEngine.Vector2[n + 1];
                tris = new int[n * 3];

                verts[0] = new UnityEngine.Vector3(0, 0, 0);
                uv[0] = new UnityEngine.Vector2(0.5f, 0.5f);



                for (int i = 0; i < n; i++) {
                    verts[i + 1] = new UnityEngine.Vector3(UnityEngine.Mathf.Sin(i * a) * radius, UnityEngine.Mathf.Cos(i * a) * radius, 0);
                    uv[i + 1] = new UnityEngine.Vector2((1 + UnityEngine.Mathf.Sin(i * a)) * 0.5f, (1 + UnityEngine.Mathf.Cos(i * a)) * 0.5f);
                }
                ...
                verts = new UnityEngine.Vector3[n * 2];
                uv = new UnityEngine.Vector2[n * 2];
                tris = new int[n * 6];

                for (int i = 0; i < n; i++) {
                    verts[i] = new UnityEngine.Vector3(UnityEngine.Mathf.Sin(i * a) * radius, UnityEngine.Mathf.Cos(i * a) * radius, 0);
                    verts[i + n] = new UnityEngine.Vector3(UnityEngine.Mathf.Sin(i * a) * radius * hollowPercent, UnityEngine.Mathf.Cos(i * a) * radius * hollowPercent, 0);
                    uv[i] = new UnityEngine.Vector2((1 + UnityEngine.Mathf.Sin(i * a)) * 0.5f, (1 + UnityEngine.Mathf.Cos(i * a)) * 0.5f);
                    uv[i + n] = new UnityEngine.Vector2((1 + UnityEngine.Mathf.Sin(i * a) * hollowPercent) * 0.5f, (1 + UnityEngine.Mathf.Cos(i * a) * hollowPercent) * 0.5f);
                }
                int t = 0;
                for (int i = 0; i < n - 1; i++) {
                    tris[t] = i;
        ...
        public static Mesh CreateRectangleMesh(float width, float height, float hollowPercent)
        {
            ...
            if (hollowPercent <= 0) {
                ...
                mesh.vertices = new UnityEngine.Vector3[4] { new UnityEngine.Vector3(-w2, h2, 0), new UnityEngine.Vector3(w2, h2, 0),
                                                 new UnityEngine.Vector3(w2, -h2, 0), new UnityEngine.Vector3(-w2, -h2, 0) };

                mesh.uv = new UnityEngine.Vector2[4] { new UnityEngine.Vector2(0, 1), new UnityEngine.Vector2(1, 1),
                                       new UnityEngine.Vector2(1, 0), new UnityEngine.Vector2(0, 0)};
                ...
                mesh.vertices = new UnityEngine.Vector3[8] { new UnityEngine.Vector3(-w2, h2, 0), new UnityEngine.Vector3(w2, h2, 0),
                                                 new UnityEngine.Vector3(w2, -h2, 0), new UnityEngine.Vector3(-w2, -h2, 0),
                                                 new UnityEngine.Vector3(-wh, hh, 0), new UnityEngine.Vector3(wh, hh, 0),
                                                 new UnityEngine.Vector3(wh, -hh, 0), new UnityEngine.Vector3(-wh, -hh, 0)};
                mesh.uv = new UnityEngine.Vector2[8] { new UnityEngine.Vector2(0, 1), new UnityEngine.Vector2(1, 1),
                                           new UnityEngine.Vector2(1, 0), new UnityEngine.Vector2(0, 0),
                                           new UnityEngine.Vector2(0.5f-p2, 0.5f+p2), new UnityEngine.Vector2(0.5f+p2,0.5f+p2),
                                           new UnityEngine.Vector2(0.5f+p2,0.5f-p2), new UnityEngine.Vector2(0.5f-p2,0.5f-p2)};
        ...
        {
            UnityEngine.Vector3[] verts = spline.GetApproximation(true);
            if (spline.Closed)
                System.Array.Resize<UnityEngine.Vector3>(ref verts, verts.Length - 1);

            return buildSplineMesh(verts, ignoreAxis, !close);
        }

        static Mesh buildSplineMesh(UnityEngine.Vector3[] vertices, int ignoreAxis, bool noTrisAtAll)
        {
            // Tris
            ...
            if (ignoreAxis == 0) { // Y/Z-Axis
                ...
                for (int i = 0; i < vertices.Length; i++)
                    UV[i] = new UnityEngine.Vector2((vertices[i].y - minU) / sizeU, (vertices[i].z - minV) / sizeV);
            }
            else if (ignoreAxis == 1) { // X/Z-Axis
                minU = B.min.x; sizeU = B.size.x;
                minV = B.min.z; sizeV = B.size.z;
                for (int i = 0; i < vertices.Length; i++)
                    UV[i] = new UnityEngine.Vector2((vertices[i].x - minU) / sizeU, (vertices[i].z - minV) / sizeV);
            }
            else { // X/Y-Axis
                minU = B.min.x; sizeU = B.size.x;
                minV = B.min.y; sizeV = B.size.y;
                for (int i = 0; i < vertices.Length; i++)
                    UV[i] = new UnityEngine.Vector2((vertices[i].x - minU) / sizeU, (vertices[i].y - minV) / sizeV);
            }
    ...
    public class CurvyUtility
    {
        ...
        public static bool isPlanar(CurvySpline spline, out bool xplanar, out bool yplanar, out bool zplanar)
        {
            ...
            for (int i = 1; i < spline.ControlPointCount; i++) {
                if (!UnityEngine.Mathf.Approximately(spline.ControlPoints[i].Position.x, p.x))
                    xplanar = false;
                if (!UnityEngine.Mathf.Approximately(spline.ControlPoints[i].Position.y, p.y))
                    yplanar = false;
                if (!UnityEngine.Mathf.Approximately(spline.ControlPoints[i].Position.z, p.z))
                    zplanar = false;
        ...
        public static void centerPivot(CurvySpline spline)
        {
            ...
            UnityEngine.Vector3 off = spline.Transform.position - b.center;
        ...
        /// <summary>
        /// Fixes NaN for UnityEngine.Vector3
        /// </summary>
        /// <param name="v">a UnityEngine.Vector3</param>
        /// <returns>the "cleaned up" vector</returns>
        public static UnityEngine.Vector3 FixNaN(UnityEngine.Vector3 v)
        {
            if (float.IsNaN(v.x)) {
                v.x = 0;
            }
        ...
        /// </summary>
        public static float GetHandleSize(UnityEngine.Vector3 position)
        {
            float s;
            if (UnityEngine.Camera.current.orthographic) {
                s = UnityEngine.Camera.current.orthographicSize * 2.5f;
            }
            else {
                Plane screen = new Plane(UnityEngine.Camera.current.transform.forward, UnityEngine.Camera.current.transform.position);
                screen.Raycast(new Ray(position, UnityEngine.Camera.current.transform.forward), out s);
            }
            return s;
        }
   ...
   */
    ...
    {
        private List<UnityEngine.Vector2> m_points = new List<UnityEngine.Vector2>();

        public Triangulator(UnityEngine.Vector2[] points)
        {
            m_points = new List<UnityEngine.Vector2>(points);
        }

        public Triangulator(UnityEngine.Vector3[] points, int ignoreAxis)
        {
            m_points = new List<UnityEngine.Vector2>(points.Length);
            switch (ignoreAxis) {
                case 0:
                    foreach (UnityEngine.Vector3 p in points)
                        m_points.Add(new UnityEngine.Vector2(p.y, p.z));
                    break;
                case 1:
                    foreach (UnityEngine.Vector3 p in points)
                        m_points.Add(new UnityEngine.Vector2(p.x, p.z));
                    break;
                default:
                    foreach (UnityEngine.Vector3 p in points)
                        m_points.Add(new UnityEngine.Vector2(p.x, p.y));
                    break;
            }
        }
        ...
        private float Area()
        {
            ...
            for (int p = n - 1, q = 0; q < n; p = q++) {
                UnityEngine.Vector2 pval = m_points[p];
                UnityEngine.Vector2 qval = m_points[q];
        ...
        {
            int p;
            UnityEngine.Vector2 A = m_points[V[u]];
            UnityEngine.Vector2 B = m_points[V[v]];
            UnityEngine.Vector2 C = m_points[V[w]];
            if (UnityEngine.Mathf.Epsilon > (((B.x - A.x) * (C.y - A.y)) - ((B.y - A.y) * (C.x - A.x))))
                return false;
            for (p = 0; p < n; p++) {
                if ((p == u) || (p == v) || (p == w))
                    continue;
                UnityEngine.Vector2 P = m_points[V[p]];
        ...
        private bool InsideTriangle(UnityEngine.Vector2 A, UnityEngine.Vector2 B, UnityEngine.Vector2 C, UnityEngine.Vector2 P)
        {
    ...
    internal struct CurvyMeshSegmentInfo
    {
        ...
        public CurvyMeshSegmentInfo(SplinePathMeshBuilder mb, float tf, UnityEngine.Vector3 scale)
        {
            Target = mb.Spline;
            TF = tf;
            mDistance = -1;

            UnityEngine.Vector3 p = (mb.FastInterpolation) ? Target.InterpolateFast(TF) : Target.Interpolate(TF);
        ...
        public CurvyMeshSegmentInfo(SplinePathMeshBuilder mb, float tf, float distance, UnityEngine.Vector3 scale)
        {
            Target = mb.Spline;
            TF = tf;
            mDistance = distance;
