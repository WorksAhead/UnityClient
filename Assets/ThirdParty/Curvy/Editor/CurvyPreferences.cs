...
public class CurvyPreferences
{
    ...
    public static EditorKeyDefinition kNext= new EditorKeyDefinition("CurvyCPNext", UnityEngine.KeyCode.T, false, false, false, false);
    public static EditorKeyDefinition kPrev = new EditorKeyDefinition("CurvyCPPrev", UnityEngine.KeyCode.T, true, false, false, false);
    public static EditorKeyDefinition kInsertAfter = new EditorKeyDefinition("CurvyCPInsertAfter", UnityEngine.KeyCode.G, false, false, false,false);
    public static EditorKeyDefinition kInsertBefore = new EditorKeyDefinition("CurvyCPInsertBefore", UnityEngine.KeyCode.G, true, false, false,false);
    public static EditorKeyDefinition kDelete = new EditorKeyDefinition("CurvyCPDelete", UnityEngine.KeyCode.H, false, false, false, false);
    public static EditorKeyDefinition kToggleFreeMove = new EditorKeyDefinition("CurvyBezierToggleFree", UnityEngine.KeyCode.N, false, false, false, false);
    ...
    public static string Color2String(UnityEngine.Color c)
    {
        return string.Format("{0};{1};{2};{3}", new object[]{c.r, c.g, c.b, c.a});
    }

    public static UnityEngine.Color String2Color(string s)
    {
        s=s.Replace(',', '.');
