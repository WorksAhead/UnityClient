...
public static class Util
{
	...
	{
		return GetFolderSizeReadable(UnityEngine.Application.dataPath + "/StreamingAssets");
	}
	...
	{
		string projectFolder = RemoveSuffix("Assets", UnityEngine.Application.dataPath);
	...
	public static string GetPackageFileContents(string filename)
	{
		...
		string defaultBuildReportToolFullPath = UnityEngine.Application.dataPath + "/" + BuildReportTool.Options.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME;
