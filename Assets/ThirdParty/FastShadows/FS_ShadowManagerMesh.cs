...
//[ExecuteInEditMode()]
public class FS_ShadowManagerMesh : UnityEngine.MonoBehaviour {
	...
	bool pingPong;
	MeshFilter _filter;
	UnityEngine.Renderer _ren;
	UnityEngine.Vector3[] _verts;
	UnityEngine.Vector2[] _uvs;
	UnityEngine.Vector3[] _norms;	
