...
/// 
/// This class is a Component. It must be added to a UnityEngine.GameObject to use it. It is a wrapper for MB2_MultiMeshCombiner which contains the same functionality but is not a component
