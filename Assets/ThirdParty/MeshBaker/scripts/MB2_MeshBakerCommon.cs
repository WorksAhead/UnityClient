...
public abstract class MB2_MeshBakerCommon : MB2_MeshBakerRoot {	
	...
	public List<UnityEngine.GameObject> objsToMesh;	
	public bool useObjsToMeshFromTexBaker = true;
	
	[HideInInspector] public UnityEngine.GameObject resultPrefab;
	[HideInInspector] public UnityEngine.GameObject resultSceneObject;
	...
	public override List<UnityEngine.GameObject> GetObjectsToCombine(){
		if (objsToMesh == null) objsToMesh = new List<UnityEngine.GameObject>();
		return objsToMesh;
	}
	...
	public void EnableDisableSourceObjectRenderers(bool show){
		for (int i = 0; i < objsToMesh.Count; i++){
			...
			if (go != null){
				UnityEngine.Renderer mr = MB_Utility.GetRenderer(go);
				if (mr != null){
					mr.enabled = show;
				}
			}
...
/// </summary>	
	...
	public abstract int GetNumVerticesFor(UnityEngine.GameObject go);
...
/// objects in gos and deleteGOs must be the game objects with a UnityEngine.Renderer component
...
/// </param>
/// </summary>
	public abstract Mesh AddDeleteGameObjects(UnityEngine.GameObject[] gos, UnityEngine.GameObject[] deleteGOs, bool disableRendererInSource, bool fixOutOfBoundUVs);

/// <summary>
/// Returns true if go is in the combined mesh.	
/// </summary>	
	public abstract bool CombinedMeshContains(UnityEngine.GameObject go);
...
/// </summary>
	public abstract void UpdateGameObjects(UnityEngine.GameObject[] gos, bool recalcBounds = true);
