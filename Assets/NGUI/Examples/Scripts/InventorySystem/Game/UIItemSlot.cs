...
public abstract class UIItemSlot : UnityEngine.MonoBehaviour
{
	...
	public UnityEngine.AudioClip grabSound;
	public UnityEngine.AudioClip placeSound;
	public UnityEngine.AudioClip errorSound;
	...
	void Update ()
	{
		...
		if (mItem != i)
		{
			...
			if (background != null)
			{
				background.color = (i != null) ? i.color : UnityEngine.Color.white;
			}
		}
	}
}
