...
public class InvBaseItem
{
	...
	/// <summary>
	/// Game UnityEngine.Object that will be created and attached to the specified slot on the body.
	/// This should typically be a prefab with a renderer component, such as a sword,
	/// a bracer, shield, etc.
	/// </summary>

	public UnityEngine.GameObject attachment;

	/// <summary>
	/// UnityEngine.Object's main material color.
	/// </summary>
