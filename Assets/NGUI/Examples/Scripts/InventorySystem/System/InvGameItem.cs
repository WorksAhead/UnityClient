...
public class InvGameItem
{
	...
	public float statMultiplier
	{
		get
		{
			...
			mult *= UnityEngine.Mathf.Lerp(linear, linear * linear, 0.5f);
			return mult;
		}
	}
	...
	public UnityEngine.Color color
	{
		get
		{
			...
			switch (quality)
			{
				case Quality.Cursed:	c = UnityEngine.Color.red; break;
				case Quality.Broken:	c = new UnityEngine.Color(0.4f, 0.2f, 0.2f); break;
				case Quality.Damaged:	c = new UnityEngine.Color(0.4f, 0.4f, 0.4f); break;
				case Quality.Worn:		c = new UnityEngine.Color(0.7f, 0.7f, 0.7f); break;
				case Quality.Sturdy:	c = new UnityEngine.Color(1.0f, 1.0f, 1.0f); break;
	...
	public List<InvStat> CalculateStats ()
	{
		...
		if (baseItem != null)
		{
			...
			for (int i = 0, imax = baseStats.Count; i < imax; ++i)
			{
				...
				int amount = UnityEngine.Mathf.RoundToInt(mult * bs.amount);
