...
public class ExampleDragDropItem : UIDragDropItem
{
	...
	protected override void OnDragDropRelease (UnityEngine.GameObject surface)
	{
		if (surface != null)
		{
			...
			if (dds != null)
			{
				UnityEngine.GameObject child = NGUITools.AddChild(dds.gameObject, prefab);
				...
				{
					trans.rotation = UnityEngine.Quaternion.LookRotation(UICamera.lastHit.normal) * UnityEngine.Quaternion.Euler(90f, 0f, 0f);
				}
