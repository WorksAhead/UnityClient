...
////// Emissive:
                ...
                float2 node_2504 = (i.uv0+(float2(node_4596.r,node_3792.g)*_flow_strength*i.uv0.r));
                ...
                return fixed4(finalColor,(node_8423.a*i.vertexColor.a*_alpha_strength*saturate((node_2246.b+i.uv0.g))*_Color.a));
            }
            ENDCG
        }
    }
