...
namespace UnityEditor.XCodeEditor
{
    public partial class XCProject : System.IDisposable
    {
          ...
          : this()
        {
            ...
            else
            {
                ...
                if (!System.IO.Path.IsPathRooted(projectRootPath))
                    projectRootPath = UnityEngine.Application.dataPath.Replace("Assets", "") + projectRootPath;
        ...
        public PBXDictionary AddFile(string filePath, PBXGroup parent = null, string tree = "SOURCE_ROOT", bool createBuildFiles = true, bool weak = false)
        {
            ...
            {
                absPath = Path.Combine(UnityEngine.Application.dataPath, filePath);
            }
        ...
        public void ApplyMod(XCMod mod)
        {
            ...
            Debug.Log("enable_oc_exceptions flags...");
            if (mod.enable_oc_exceptions != null)
            {
                foreach (string flag in mod.enable_oc_exceptions)
                {
                    this.overwriteBuildSetting("GCC_ENABLE_OBJC_EXCEPTIONS", flag, "Release");
                    this.overwriteBuildSetting("GCC_ENABLE_OBJC_EXCEPTIONS", flag, "Debug");
                }
            }
