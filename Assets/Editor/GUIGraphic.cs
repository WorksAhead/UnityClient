...
public class GUIGraphic
{
    ...
    protected static bool segment_rect_intersection(Rect bounds, ref UnityEngine.Vector2 p1, ref UnityEngine.Vector2 p2)
    {
    ...
    public static void DrawLine(UnityEngine.Vector2 pointA, UnityEngine.Vector2 pointB, UnityEngine.Color color)
    {
        if (clippingEnabled)
