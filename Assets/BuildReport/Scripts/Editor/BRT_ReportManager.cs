...
public partial class ReportManager
{
	...
	public static void Init(ref BuildInfo buildInfo)
	{
		...
		buildInfo.ProjectAssetsPath = UnityEngine.Application.dataPath;
		...
		buildInfo.UnityVersion = "Unity " + UnityEngine.Application.unityVersion;
	...
	static void AddAllPrefabsUsedInCurrentSceneToList()
	{
		...
		AddAllPrefabsUsedInScene(EditorApplication.currentScene);
			#else
		UnityEngine.GameObject[] allObjects = (UnityEngine.GameObject[])UnityEngine.Object.FindObjectsOfType(typeof(UnityEngine.GameObject));
...
*/
	...
	public static void ChangeSavePathToProjectFolder()
	{
		...
		{
			projectParent = UnityEngine.Application.dataPath;
		}
